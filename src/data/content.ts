...
export const uiTranslations = {
  EN: {
    ...
    seconds: "seconds",
    infoTitle: "TONIGHT",
    infoDesc1: "This is not just another dinner, but an experience you share and live together.",
    infoDesc2: "Choose your menu, follow the moments as they arrive, and let the evening unfold at its own pace.",
  ...
  ES: {
    ...
    infoDesc1: "Esta no es solo otra cena, sino una experiencia que viven juntos.",
    infoDesc2: "Elijan su menú, sigan los momentos a medida que llegan y dejen que la noche se desarrolle a su propio ritmo.",
  ...
  RU: {
    ...
    infoDesc1: "Это не просто очередной ужин, а опыт, который вы проживаете вместе.",
    infoDesc2: "Выберите меню, следуйте за моментами по мере их появления, и позвольте вечеру раскрываться в своем собственном темпе.",
